package com.zx.ci.textanalysis.termvector.test;
...
import com.zx.ci.textanalysis.lucene.impl.TagCacheImpl;
...
public class TagMagnitudeVectorTest extends TestCase {
  ...
  public void testCreateVectors() throws Exception {
    ...
    assertTrue("First tag should be b " + tag, "b".equals(tag.getStemmedText()));
    tag = tmList.get(2).getTag();
    assertTrue("First tag should be a " + tag, "a".equals(tag.getStemmedText()));
  }
