 ...
 * </p>
 * <p>
 * Description: Rule Execution Set Provider Implementation.
 * </p>
 * <p>
...
public class RuleExecutionSetProviderImpl implements RuleExecutionSetProvider {
  ...
  /**
   * Creates a RuleExecutionSet implementation from an XML Document and
   * additional vendor-specific properties.
   */
  public RuleExecutionSet createRuleExecutionSet(Element docElement,
      Map properties) throws RuleExecutionSetCreateException, RemoteException {
    return (new LocalRuleExecutionSetProviderImpl()).createRuleExecutionSet(
        docElement, properties);
  }
   ...
   */
  public RuleExecutionSet createRuleExecutionSet(Serializable ast,
      Map properties) throws RuleExecutionSetCreateException, RemoteException {
  ...
  public RuleExecutionSet createRuleExecutionSet(String uri, Map properties)
    ...
    return (new LocalRuleExecutionSetProviderImpl()).createRuleExecutionSet(is,
        properties);
  }
