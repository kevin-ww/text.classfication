 ...
 * </p>
 * <p>
 * Description: Rule Administrator Implementation.
 * </p>
 * <p>
...
public class RuleAdministratorImpl implements RuleAdministrator {
  ...
  /** rule execution sets */
  private static Map ruleExecutionSets = Collections
   ...
   */
  public final RuleExecutionSetProvider getRuleExecutionSetProvider(
   ...
   */
  public final LocalRuleExecutionSetProvider getLocalRuleExecutionSetProvider(
      Map properties) throws RemoteException, UnsupportedOperationException {
   ...
   *          not supported
   */
  public final void registerRuleExecutionSet(String bindUri,
      RuleExecutionSet set, Map properties)
  ...
  public final void deregisterRuleExecutionSet(String bindUri, Map properties)
    ...
    RuleExecutionSetImpl set = (RuleExecutionSetImpl) ruleExecutionSets
        .remove(bindUri);
    if (set != null)
      set.setUri(null);
  }
