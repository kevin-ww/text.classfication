 ...
 * </p>
 * <p>
 * Description: this class is a representation of a stateless rules engine
 * session. A stateless rules engine session exposes a stateless rule execution
 * API to an underlying rules engine.
 * </p>
 * <p>
...
public class StatelessRuleSessionImpl implements StatelessRuleSession {
  ...
  /**
   * Executes the rules in the bound rule execution set using the supplied list
   * of objects.
   */
