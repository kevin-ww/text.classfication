...
/**
 * This class implement a simple example using a rule execution set from the
 * Test Compatibility Kit.
 * 
 * See for the TCK for more information on the object model and the rule
 * execution set.
 * 
 * This example requires the following jar file to be present on your classpath:
 * jsr94.jar jsr94-ri.jar jsr94-tck.jar xerces.jar jess.jar (The reference
 * implementation)
 * 
 * To run this example execute the following command in the lib directory of the
 * jsr94 distribution: java -jar jsr94-example.jar
 */
public class Example {
  ...
  public static void main(String[] args) {
    try {
      ...
      InputStream inStream = org.jcp.jsr94.tck.model.Customer.class
          .getResourceAsStream("/org/jcp/jsr94/tck/tck_res_1.xml");
      ...
      System.out.println(inputInvoice.getDescription() + " amount: "
          + inputInvoice.getAmount() + " status: " + inputInvoice.getStatus());
      ...
      while (itr.hasNext()) {
        ...
        if (obj instanceof Invoice)
          System.out.println(((Invoice) obj).getDescription() + " amount: "
      ...
      System.out.println(inputInvoice.getDescription() + " amount: "
          + inputInvoice.getAmount() + " status: " + inputInvoice.getStatus());
      System.out
          .println(inputInvoice2.getDescription() + " amount: "
      ...
      if (e.getMessage().indexOf("JessException") != -1) {
        System.err
            .println("Error: The reference implementation Jess could not be found.");
      } else {
