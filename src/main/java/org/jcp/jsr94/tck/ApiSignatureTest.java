...
/**
 * Signature test for the JSR 94. The signature test checks whether an
 * implementation is compliant with the constructor, method and field signatures
 * defined by the JSR. Any modifications will be reported as errors.
 * <p>
...
public class ApiSignatureTest extends TestCase {
  /**
   * ApiSignatureTest constructor. This is the default constructor for a JUnit
   * TestCase.
   * 
   * @param name
   ...
   * <p>
   * <b>Description:</b><br>
   * The signature test will check whether or not the current test run is using
   * an unmodified API which is completely conforment with the API as defined by
   * the JSR. The location of the signature file is defined by the
