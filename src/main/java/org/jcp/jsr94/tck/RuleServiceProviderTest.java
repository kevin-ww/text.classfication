...
public class RuleServiceProviderTest extends TestCase {
  /**
   * RuleServiceProviderTest constructor. This is the default constructor for a
   * JUnit TestCase.
   * 
   * @param name
  ...
  /**
   * Test the compliance for javax.rules.RuleServiceProvider. This test will
   * retrieve the rule engine vendor specific rule service provider class name
   * from the tck.conf configuration file. An instance will be created via the
   * static createInstance method of the RuleServiceProvider class. The rule
   * administrator and rule runtime APIs will be tested.
   * <p>
   * <b>Description:</b><br>
   * <ul>
   * <li>Create Instance
   * <ul>
   * <li>Fail: If any exception occurs during the creation of the rule service
   * provider.
   * <li>Succeed: If the rule service provider can successfully be instantiated.
   * </ul>
   * <li>Retrieve RuleAdministrator
   * <ul>
   * <li>Fail: If any exception occurs during the creation of the rule service
  ...
  public void testRuleServiceProvider() {
    try {
      ...
      assertNotNull("[RuleServiceProviderTest] "
          + "No rule service provider name found.", providerName);
      ...
      // provider.
      assertNotNull("[RuleServiceProviderTest] "
          + "Could not instantiate a Rule service provider.", obj);
      ...
      assertTrue("[RuleServiceProviderTest] ", (obj instanceof RuleRuntime));
    } catch (Exception e) {
      fail(e.getMessage());
    }
  }
