...
public class InvalidRuleSessionExceptionTest extends TestCase {
  /**
   * InvalidRuleSessionExceptionTest constructor. This is the default
   ...
   * <p>
   * <b>Description:</b><br>
   * Create two instances of the InvalidRuleSessionException. The first instance
   * will be constructed with an additonal message. The second instance will
   * have its own message as well as wrap the first instance. The class
   * hierarchy will be tested. The second exception will be thrown. The
   * exception will be caught and the test will verify whether the exception can
   * successfully be unwrapped. The following tests will be performed.
   * <ul>
   * <li>Instance Creation
   * <ul>
   * <li>Fail: If InvalidRuleSessionException cannot be created by any of the
   * JSR specified constructors.
   ...
   * <li>Exception Wrapping
   * <ul>
   * <li>Fail: If any other than the the original InvalidRuleSessionException is
   * unwrapped.
