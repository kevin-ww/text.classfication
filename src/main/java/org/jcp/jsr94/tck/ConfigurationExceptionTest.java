...
public class ConfigurationExceptionTest extends TestCase {
  /**
   * ConfigurationExceptionTest constructor. This is the default constructor for
   * a JUnit TestCase.
   * 
   * @param name
   ...
   * <p>
   * <b>Description:</b><br>
   * Create two instances of the ConfigurationException. The first instance will
   ...
   * <li>Instance Creation
   * <ul>
   * <li>Fail: If ConfigurationException cannot be created by any of the JSR
   ...
   * <li>Exception Wrapping
   * <ul>
   * <li>Fail: If any other than the the original ConfigurationException is
   * unwrapped.
  ...
  public void testConfigurationException() {
    ...
    try {
      ce1 = new ConfigurationException("jsr94-test-configuration-exception");
