...
/**
 * This class defines the Invoice business object that is part of the JSR-94
 * TCK.
 * 
 * The Invoice class is a simple class that contains the following properties:<br>
 * <ul>
 * <li>description
 * <li>amount
 * <li>status
