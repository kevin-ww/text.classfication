 ...
 * tck_res_1.xml. You have to change this file accoding to your rule execution
 * set definition. The mainline TCK documentation describes the contents of this
 * rule execution set definition.
 * 
 * @version 1.0
 * @since JSR-94 1.0
...
public class RuleExecutionSetMetadataTest extends TestCase {
  ...
  /**
   * RuleExecutionSetMetadataTest constructor. This is the default constructor
  ...
  /**
   * Initialize the RuleExecutionSetMetadataTest. Initializes a stateless rule
   * ression. This test uses the tck_res_1.xml RuleExecutionSet definition file.
   * The rule session is created by the TestCaseUtil utility class.
   * 
   ...
   * <p>
   * <b>Description:</b><br>
   * Create a stateless rule session and retrieve the rule execution set
   * metadata. Determine the name and uri of this metadata.
   * <ul>
   * <li>Retrieve Metadata
   * <ul>
   * <li>Fail: If the rule execution set metadata cannot be retrieved from the
   * rule session.
   * <li>Succeed: If a non null RuleExecutionSetMetadata is retrieved.
   * </ul>
   * <li>Verify URI
   * <ul>
   * <li>Fail: If uri is not the same as specified during the binding of the
   * rule execution set.
  ...
  public void testRuleExecutionSetMetadata() {
    try {
      RuleExecutionSetMetadata data = ruleSession.getRuleExecutionSetMetadata();
      ...
      assertEquals("[RuleExecutionSetMetadataTest] ", RULE_EXECUTION_SET_URI,
          data.getUri());
