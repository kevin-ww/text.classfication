 ...
 * <p>
 * This class implements an ObjectFilter that will be used in testing the
 * ObjectFilter functionality of rule sessions.
 * 
 * The filter will filter objects based on their class definition. The type of
 * the filter, specified in the constructor, will determine which class will be
 * filtered out.
 * 
 * @version 1.0
 * @since JSR-94 1.0
