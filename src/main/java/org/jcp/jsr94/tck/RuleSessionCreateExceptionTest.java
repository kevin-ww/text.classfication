...
public class RuleSessionCreateExceptionTest extends TestCase {
  /**
   * RuleSessionCreateExceptionTest constructor. This is the default constructor
   ...
   * instance will be constructed with an additonal message. The second instance
   * will have its own message as well as wrap the first instance. The class
   ...
   * <li>Instance Creation
   * <ul>
   * <li>Fail: If RuleSessionCreateException cannot be created by any of the JSR
   ...
   * <li>Exception Wrapping
   * <ul>
   * <li>Fail: If any other than the the original RuleSessionCreateException is
   * unwrapped.
