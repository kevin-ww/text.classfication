...
public class LocalRuleExecutionSetProviderTest extends TestCase {
  /**
   * LocalRuleExecutionSetProviderTest constructor. This is the default
   * constructor for a JUnit TestCase.
   * 
   * @param name
   ...
   * LocalRuleExecutionSetProvider via the RuleServiceProvider specified in the
   * tck.conf configuration file. Get the RuleAdministrator from this service
   * provider which will have a reference to a LocalRuleExecutionSetProvider.
   * The test will continue with constructing a RuleExecutionSet from an
   * InputStream and a Reader. In both cases the "tck_res_1.xml" rule execution
   * set definition will be used as input.
   * <p>
   * <b>Description:</b><br>
   * <ul>
   * <li>Create Instance
   ...
   * from an InputStream.
   * <li>Succeed: If a RuleExecutionSet can successfully be created from an
   * InputStream.
   * </ul>
   * <li>Reader
   * <ul>
   * <li>Fail: If any errors occur during the creation of a RuleExecutionSet
   * from a Reader.
   * <li>Succeed: If a RuleExecutionSet can successfully be created from a
   * Reader.
   * </ul>
   * </ul>
   * 
  ...
  public void testLocalRuleExecutionSetProvider() throws Exception {
    ...
    RuleServiceProvider serviceProvider = TestCaseUtil
        .getRuleServiceProvider("LocalResTest");
    ...
    assertNotNull("[localRuleExecutionSetProviderTest] ", localProvider);
