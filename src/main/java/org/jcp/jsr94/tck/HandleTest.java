 ...
 * <li>The object returned by {@link StatefulRuleSession#getObject(Handle)} must
 * be equals to the initial object.
 ...
 * tck_res_2.xml. You have to change this file accoding to your rule execution
...
public class HandleTest extends TestCase {
  ...
  /**
   * HandleTest constructor. This is the default constructor for a JUnit
   * TestCase.
   * 
   * @param name
  ...
  /**
   * Initialize the HandleTest. Initializes a stateful rule ression. This test
   * uses the tck_res_2.xml RuleExecutionSet definition file.
   * 
  ...
  public void testHandle() throws Exception {
    ...
    assertTrue("[HandleTest] instanceof Handle", (handle instanceof Handle));

    assertTrue("[HandleTest] containsObject",
        ruleSession.containsObject(handle));

    Object newobject = ruleSession.getObject(handle);
    assertTrue("[HandleTest] calling equals", object.equals(newobject));
