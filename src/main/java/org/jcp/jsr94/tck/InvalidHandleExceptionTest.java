...
public class InvalidHandleExceptionTest extends TestCase {
  /**
   * InvalidHandleExceptionTest constructor. This is the default constructor for
   * a JUnit TestCase.
   * 
   * @param name
   ...
   * <p>
   * <b>Description:</b><br>
   * Create two instances of the InvalidHandleException. The first instance will
   * be constructed with an additonal message. The second instance will have its
   * own message as well as wrap the first instance. The class hierarchy will be
   * tested. The second exception will be thrown. The exception will be caught
   * and the test will verify whether the exception can successfully be
   * unwrapped. The following tests will be performed.
   * <ul>
   * <li>Instance Creation
   * <ul>
   * <li>Fail: If InvalidHandleException cannot be created by any of the JSR
   ...
   * <li>Exception Wrapping
   * <ul>
   * <li>Fail: If any other than the the original InvalidHandleException is
   * unwrapped.
  ...
  public void testInvalidHandleException() {
    ...
    try {
      ie1 = new InvalidHandleException("jsr94-test-invalid-handle-exception");
